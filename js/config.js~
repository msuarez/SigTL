...
function init() {
			...
			var projOlMap = new OpenLayers.Projection('EPSG:900913');//('EPSG:900913'); 			// projection a usar por el map OpenLayers
			...
			var opOlMap = {maxResolution: 'auto', units: 'm', controls:[], projection: projOlMap, maxExtent: misBounds};
...
//			olMap.addLayer(cATens);
			...
			olMap.addLayers([mapa, fisico, satelite ]);
